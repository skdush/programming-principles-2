...
def draw_grid(screen, width, height, step=40):
    """Рисует сетку для красоты (не обязательно)"""
...
def draw_hud(screen, ball, font_med, font_small):
    """Рисует интерфейс: координаты и управление"""
    # Панель снизу
    ...
    hint = font_small.render(
        "Arrow Keys — move 20px  |  ESC — quit", True, DARK_GRAY
    )
...
def main():
    ...
    ball = Ball(WIDTH, HEIGHT - 60)  # -60 под HUD
